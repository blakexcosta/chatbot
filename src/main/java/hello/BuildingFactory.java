...
//importing the necessary python classes for conversion
// import BuildingInterface
...
public class BuildingFactory {
    ...
    public BuildingInterface create (String name, String location, String id) {

        PyObject buildingObject = buildingClass.__call__(new PyString(name),
                new PyString(location),
                new PyString(id));
        return (BuildingInterface) buildingObject.__tojava__(BuildingInterface.class);
    }
}
